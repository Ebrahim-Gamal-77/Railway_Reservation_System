...
class RailwayManagementSystem:
    def __init__(self, root):
        ...
        self.style.configure("TLabel", font=("Helvetica Neue", 12), background="#f4f4f9", foreground="#333")
        self.style.configure("TButton", font=("Helvetica Neue", 12), padding=10, relief="flat", background="#4CAF50", foreground="white")
        self.style.configure("Title.TLabel", font=("Helvetica Neue", 18, "bold"), background="#f4f4f9", foreground="#333")
    ...
    def main_menu(self):
        ...
        ttk.Label(self.root, text="Railway Management System", style="Title.TLabel").pack(pady=40)

        ttk.Button(self.root, text="Admin Login", command=self.admin_login).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Passenger Login", command=self.passenger_login).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Register as Passenger", command=self.register_passenger).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Exit", command=self.root.quit).pack(pady=10, fill='x', padx=150)
    ...
    def admin_login(self):
        ...
        ttk.Button(self.root, text="Login", command=login).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=self.main_menu).pack(pady=10, fill='x', padx=150)
    ...
    def admin_menu(self):
        ...
        ttk.Button(self.root, text="Add Train", command=self.add_train).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="View All Trains", command=self.view_trains).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=self.main_menu).pack(pady=10, fill='x', padx=150)
    ...
    def add_train(self):
        ...
        ttk.Label(self.root, text="Train ID:").pack(pady=5)
        train_id_entry = ttk.Entry(self.root)
        train_id_entry.pack(pady=5)

        ttk.Label(self.root, text="Train Name:").pack(pady=5)
        train_name_entry = ttk.Entry(self.root)
        train_name_entry.pack(pady=5)

        ttk.Label(self.root, text="Route:").pack(pady=5)
        route_entry = ttk.Entry(self.root)
        route_entry.pack(pady=5)

        ttk.Label(self.root, text="Total Seats:").pack(pady=5)
        ...
        ttk.Button(self.root, text="Add Train", command=save_train).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=self.admin_menu).pack(pady=10, fill='x', padx=150)
    ...
    def register_passenger(self):
        ...
        ttk.Button(self.root, text="Register", command=register).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=self.main_menu).pack(pady=10, fill='x', padx=150)
    ...
    def passenger_menu(self, username):
        ...
        for train in self.trains:
            ttk.Label(self.root, text=str(train)).pack(pady=5)
        ttk.Button(self.root, text="Book Ticket", command=lambda: self.book_ticket(username)).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Cancel Ticket", command=lambda: self.cancel_ticket(username)).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="View Booked Tickets", command=lambda: self.view_booked_tickets(username)).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=self.main_menu).pack(pady=10, fill='x', padx=150)
    ...
    def book_ticket(self, username):
        ...
        ttk.Button(self.root, text="Book Ticket", command=confirm_booking).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=lambda: self.passenger_menu(username)).pack(pady=10, fill='x', padx=150)
    ...
    def cancel_ticket(self, username):
        ...
        ttk.Button(self.root, text="Cancel Ticket", command=confirm_cancellation).pack(pady=10, fill='x', padx=150)
        ttk.Button(self.root, text="Back", command=lambda: self.passenger_menu(username)).pack(pady=10, fill='x', padx=150)
    ...
    def view_booked_tickets(self, username):
        ...
        ttk.Button(self.root, text="Back", command=lambda: self.passenger_menu(username)).pack(pady=20, fill='x', padx=150)
